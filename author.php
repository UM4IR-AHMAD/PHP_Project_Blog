...
<?php
                    ...
                    $sqlQuery = "SELECT COUNT(post_id) as totalNoOfRecords, user.first_name, user.last_name
                    FROM post JOIN user ON user.user_id = {$_GET['aid']}
...
<div id="main-container">
        <main>
            ...
            <div class = "pagination-container">
                    <ul>
                        <?php
                            if($CurrentPage > 1) echo '<li><a href="author.php?aid='.$_GET['aid'].'&page='.($CurrentPage - 1).'">Prev</a></li>';                
                            for ($i=1; $i <= $NoOfPages ; $i++) {
                                ...
                                echo '<li><a  class ="'.$HighlightPageNumber.'"  href="author.php?aid='.$_GET['aid'].'&page='.$i.'">'.$i.'</a></li>';
                            }
                            if($CurrentPage < $NoOfPages) echo '<li><a href="author.php?aid='.$_GET['aid'].'&page='.($CurrentPage + 1).'">Next</a></li>';
                        ?>
                    </ul>
</div>
        </main>
